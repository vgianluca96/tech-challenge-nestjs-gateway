...
This is a backend application that acts as a Gateway that redirects requests to a target backend application, whose URL can be configured in envrionment variables.
...
AUTH_SERVICE_URL=<the URL assigned to the target microservice>
```
